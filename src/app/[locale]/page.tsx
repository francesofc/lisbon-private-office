    ...
    <>
          ...
          <div className="mt-28 lg:mt-36 grid grid-cols-1 md:grid-cols-3 gap-20 lg:gap-24">
            {dict.whyUs.items.map((item) => (
              <div key={item.title} className="text-center group">
                ...
                <h3 className="font-serif text-[26px] lg:text-[30px] font-light mb-7 text-black-deep tracking-[-0.02em]">{item.title}</h3>
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-px bg-beige-dark/25">
            {dict.whoIsFor.profiles.map((profile) => (
              <div key={profile.title} className="bg-beige p-14 lg:p-20 group">
                ...
                <h3 className="font-serif text-[22px] lg:text-[26px] font-light text-black-deep tracking-[-0.02em] mb-5">{profile.title}</h3>
            ...
            {dict.process.steps.map((step, i) => (
              <div key={step.number} className="flex gap-8 lg:gap-14 group">
                ...
                <div className="pb-14 lg:pb-18">
                  <h3 className="font-serif text-[22px] lg:text-[26px] font-light text-black-deep tracking-[-0.02em] mb-4">{step.title}</h3>
      ...
      <section className="py-32 lg:py-44 bg-black-deep relative">
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          <div className="mt-10 max-w-xl mx-auto text-center">
            <p className="font-serif text-[36px] font-light tracking-[-0.01em] text-gold/80 mb-6">{dict.vip.price}</p>
          ...
          <div className="mt-16 max-w-lg mx-auto">
            <div className="grid grid-cols-1 gap-4">
              {dict.vip.features.map((item) => (
                <div key={item} className="flex items-center gap-5 text-[13px] tracking-[0.01em] text-beige/35 py-2 border-b border-beige/5 last:border-0">
        ...
        <div className="max-w-[900px] mx-auto px-8 lg:px-16">
          ...
          <div className="mt-16 p-12 lg:p-20 bg-white relative">
            ...
            <div className="text-center mb-14">
              <h3 className="font-serif text-[22px] lg:text-[26px] font-light text-black-deep tracking-[-0.02em] mb-3">{dict.membership.packageTitle}</h3>
      ...
      <section className="py-40 lg:py-52 bg-beige relative">
        <div className="max-w-[700px] mx-auto px-8 lg:px-16 text-center">
          ...
          <h2 className="font-serif text-[32px] md:text-[40px] lg:text-[48px] font-light text-black-deep leading-[1.18] tracking-[-0.02em] mb-8">
            {dict.cta.titleLine1}<br />{dict.cta.titleLine2}
          </h2>
          <p className="text-[14px] leading-[1.95] tracking-[0.015em] text-warm-gray/80 mb-16 max-w-md mx-auto">{dict.cta.text}</p>
