...
export default async function HomePage({
  ...
  return (
    <>
          ...
          <div className="max-w-2xl">
            ...
            <FadeIn delay={650}>
              <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
                <Link href={`/${locale}/contact`} className="px-12 md:px-16 py-4 md:py-[19px] bg-[#C6A66B] text-[#0E0E0E] text-[11px] tracking-[0.22em] uppercase font-semibold hover:bg-white hover:text-[#0E0E0E] transition-all duration-400 ease-[cubic-bezier(0.25,0.1,0.25,1)] text-center">
                  {dict.hero.cta1}
                </Link>
                <Link href={`/${locale}/services`} className="px-10 md:px-14 py-4 md:py-[19px] border border-white/10 text-white/30 text-[11px] tracking-[0.2em] uppercase hover:border-white/25 hover:text-white/60 transition-all duration-400 ease-[cubic-bezier(0.25,0.1,0.25,1)] text-center">
                  {dict.hero.cta2}
                </Link>
              </div>
            </FadeIn>
      ...
      <section className="py-28 md:py-48 lg:py-68 bg-offwhite relative">
        <div className="max-w-[1100px] mx-auto px-7 md:px-8 lg:px-16">
          <FadeIn>
          ...
          <div className="mt-20 md:mt-36 lg:mt-48 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 lg:gap-10">
            {dict.whyUs.items.map((item, i) => (
              <FadeIn key={item.title} delay={i * 120}>
                <div className="text-center group p-8 md:p-10 lg:p-14 hover:bg-white/60 transition-all duration-500 ease-out">
                  <div className="w-5 h-px bg-gold/25 mx-auto mb-8 md:mb-12 group-hover:w-12 group-hover:bg-gold/45 transition-all duration-500 ease-out" />
                  <h3 className="font-serif text-[24px] md:text-[26px] lg:text-[30px] font-light mb-6 md:mb-8 text-black-deep tracking-[-0.015em] group-hover:text-black-deep transition-colors duration-400">{item.title}</h3>
      ...
      <section className="py-24 md:py-44 lg:py-64 bg-beige relative">
          ...
          <FadeIn delay={100}>
            <div className="mt-16 md:mt-24 lg:mt-32 grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 lg:gap-8">
              {dict.whoIsFor.profiles.map((profile) => (
                <div key={profile.title} className="bg-beige p-10 md:p-14 lg:p-20 group border border-beige-dark/15 hover:border-beige-dark/30 hover:bg-white/30 transition-all duration-500 ease-out">
                  <div className="w-5 h-px bg-gold/30 mb-8 md:mb-10 group-hover:w-10 group-hover:bg-gold/50 transition-all duration-500 ease-out" />
      ...
      <section className="py-24 md:py-44 lg:py-64 bg-beige relative">
        <div className="max-w-[1200px] mx-auto px-7 md:px-8 lg:px-16">
                    ...
                    <div className="flex gap-7 md:gap-10 lg:gap-14 group">
                      <div className="flex flex-col items-center shrink-0">
                        ...
                        {i < dict.process.steps.length - 1 && (
                          <div className="w-px flex-1 bg-beige-dark/30 min-h-[48px] md:min-h-[60px]" />
                        )}
                      </div>
      ...
      <section className="py-28 md:py-44 lg:py-64 bg-black-deep relative">
        ...
        <div className="max-w-[1400px] mx-auto px-7 md:px-8 lg:px-16">
          ...
          <FadeIn delay={100}>
            <div className="mt-12 md:mt-16 max-w-xl mx-auto text-center">
              <p className="font-serif text-[30px] md:text-[36px] font-light tracking-[-0.01em] text-gold/80 mb-6 md:mb-8">{dict.vip.price}</p>
            ...
            <div className="mt-16 md:mt-24 max-w-lg mx-auto">
              <div className="grid grid-cols-1 gap-5 md:gap-6">
                {dict.vip.features.map((item) => (
                  <div key={item} className="flex items-center gap-5 text-[13px] md:text-[13px] tracking-[0.01em] text-beige/35 py-3 border-b border-beige/5 last:border-0">
          ...
          <FadeIn delay={100}>
            <div className="mt-16 md:mt-24 flex flex-wrap gap-3 md:gap-5">
              {dict.lifestyle.categories.map((category) => (
                <div key={category} className="px-7 md:px-9 py-4 md:py-5 border border-beige-dark/25 text-[12px] tracking-[0.08em] text-warm-gray/80 hover:border-gold/35 hover:text-black-deep transition-all duration-400 ease-out">
                  {category}
                </div>
              ))}
            </div>
      ...
      <section className="py-24 md:py-44 lg:py-58 bg-beige relative">
        <div className="max-w-[1100px] mx-auto px-7 md:px-8 lg:px-16">
          <FadeIn>
          ...
          <FadeIn delay={100}>
            <div className="mt-16 md:mt-24 max-w-2xl p-10 md:p-16 lg:p-28 bg-white relative">
              <div className="absolute top-0 left-10 right-10 md:left-16 md:right-16 lg:left-28 lg:right-28 h-px bg-gold/20" />
              <div className="mb-12 md:mb-18">
                ...
                <p className="font-serif text-[28px] md:text-[32px] font-light tracking-[-0.01em] text-gold">
                  {dict.membership.price} <span className="text-[14px] md:text-[15px] text-warm-gray/50">{dict.membership.perYear}</span>
                </p>
              </div>
              <div className="w-8 h-px bg-beige-dark/35 mb-10 md:mb-14" />
      ...
      <section className="py-24 md:py-44 lg:py-58 bg-offwhite relative">
        <div className="max-w-[1400px] mx-auto px-7 md:px-8 lg:px-16">
          ...
          <FadeIn delay={100}>
            <div className="mt-16 md:mt-28 grid grid-cols-2 md:grid-cols-5 gap-px bg-beige-dark/25">
              {dict.network.categories.map((category) => (
                <div key={category} className="bg-offwhite p-6 md:p-8 lg:p-12 text-center group">
      ...
      <section className="py-24 md:py-44 lg:py-58 bg-black-deep relative">
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold/10 to-transparent" />
        <div className="max-w-[900px] mx-auto px-7 md:px-8 lg:px-16">
          <FadeIn>
          ...
          <FadeIn delay={100}>
            <div className="mt-14 md:mt-20 flex flex-wrap justify-center gap-3 md:gap-4">
              {dict.events.types.map((event) => (
                <div key={event} className="px-6 md:px-8 py-3.5 md:py-4 border border-beige/8 text-[12px] tracking-[0.05em] text-beige/35 hover:border-gold/25 hover:text-gold/65 transition-all duration-400 ease-out">
                  {event}
                </div>
              ))}
            </div>
      ...
      {/* ============ FINAL CTA — centered ============ */}
      <section className="py-32 md:py-52 lg:py-72 bg-beige relative pb-44 md:pb-52 lg:pb-72">
        <div className="max-w-[700px] mx-auto px-7 md:px-8 lg:px-16 text-center">
          <FadeIn>
            <div className="w-10 h-px bg-gold/30 mx-auto mb-10 md:mb-14" />
          ...
          <FadeIn delay={150}>
            <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-5">
              <Link href={`/${locale}/contact`} className="inline-block px-12 py-4 md:py-[17px] bg-black-deep text-beige/80 text-[11px] tracking-[0.18em] uppercase hover:bg-black-soft hover:text-beige transition-all duration-400 ease-out">
                {dict.cta.button}
              </Link>
              <Link href={`/${locale}/contact`} className="inline-block px-10 py-4 md:py-[17px] border border-black-deep/12 text-black-deep/45 text-[11px] tracking-[0.18em] uppercase hover:border-black-deep/35 hover:text-black-deep transition-all duration-400 ease-out">
